				...
				<div class="container">
					...
					<div class="navbar-collapse collapse ">
						<ul class="nav navbar-nav">
							<li><a href="Ideal/index.jsp">Dashboard</a></li>
							<li class="dropdown active"><a href="#"
								...
								<ul class="dropdown-menu">
									<li><a href="Ideal/index.jsp">Enquiry</a>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="text-center">
							<p><br>
								Welcome Back <strong>Harmeet Kaur</strong> -Your last login was on
								Tuesday, 06 Mar 2018 10:37 from IDEAL 3.0()
							</p>
						</div>
						<div class="row">
							...
							<div class="col-sm-7 col-md-7">
								<div class="testimonialslide clearfix flexslider">
									<table class="table table-bordered">
										<thead>
											<tr>
												<th class="highlight" scope="col">Approve <span
													style="float: right;">Last updated on Tuesday, 06
														Mar 2018 11:00 Refresh</span></th>
											</tr>
										</thead>
										<tbody>
											<tr>
												<td>Cash | Trade | File Exchange</td>
											</tr>
										</tbody>
									</table>
									<br />
									<table class="table table-bordered">
										<thead>
											<tr>
												<th class="highlight" scope="col">Make <span
													style="float: right;">Edit</span></th>
											</tr>
										</thead>
										<tbody>
											<tr>
									...
									<table class="table table-bordered">
										<thead>
											<tr>
												<th class="highlight" scope="col">Enquiries- Balance<span
													style="float: right;">Last updated on Tuesday, 06
														Mar 2018 11:00 Refresh</span></th>
											</tr>
										</thead>
										<tbody>
											<tr>
												<td><ul class="nav nav-tabs">
														<li class="active"><a href="#acc" data-toggle="tab"><i
																class="icon-briefcase"></i> Accounts</a></li>
														<li><a href="#fd" data-toggle="tab">Fixed
																Deposits</a></li>
													...
													<div class="tab-content">
														<div class="tab-pane active" id="acc">
															<table class="table table-dark">
																<tbody>
																	<tr>
																		<th scope="row">154846111111111</th>
																		<td>|DBS Ideal Test Account 1</td>
																	</tr>
																	<tr>
																		<th scope="row">16584814446786</th>
																		<td>|DBS Ideal Test Account 2</td>
																	</tr>
																	<tr>
																		<th scope="row">1878656652468158</th>
																		<td>|DBS Ideal Test Account 3</td>
														...
														<div class="tab-pane" id="fd">
															<table class="table table-dark">
																<tbody>
																	<tr>
																		<th scope="row">3455555555222222222</th>
																		<td>|DBS Ideal Test Account 1</td>
																	</tr>
																	<tr>
																		<th scope="row">245788888888</th>
																		<td>|DBS Ideal Test Account 2</td>
																	</tr>
																	<tr>
																		<th scope="row">187588456652468158</th>
																		<td>|DBS Ideal Test Account 3</td>
														...
														<div class="tab-pane" id="loans">
															<table class="table table-dark">
																<tbody>
																	<tr>
																		<th scope="row">1548465851111111</th>
																		<td>|DBS Ideal Test Account 1</td>
																	</tr>
																	<tr>
																		<th scope="row">1652525246786</th>
																		<td>|DBS Ideal Test Account 2</td>
																	</tr>
																	<tr>
																		<th scope="row">1147586652468158</th>
																		<td>|DBS Ideal Test Account 3</td>
										...
										<li class="list-group-item">
											...
											<ul class="nav nav-tabs">
												<li class="active"><a href="#one" data-toggle="tab"><i
														class="icon-briefcase"></i> Cheque</a></li>
												<li><a href="#two" data-toggle="tab">Payment</a></li>
												<li><a href="#three" data-toggle="tab">Activities</a></li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane active" id="one">
													<form>
														<div class="form-group">
															<label for="formGroupExampleInput">Account No</label> <select
																class="form-control form-control-lg">
																<option>Acct 1</option>
																<option>Acct 2</option>
																<option>Acct 3</option>

															</select>
														</div>
														<div class="form-group">
															<label for="formGroupExampleInput2">Cheque No</label> <input
